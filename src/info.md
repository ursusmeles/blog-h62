...
layout: page.njk
title: Informacje
lead: Dowiedz się, skąd wziął się Heliocantharus, kto jest jego autorem i na jakich zasadach są tworzone i udostępniane treści na blogu.
---

<section class="deck-container stack">
  {% set info_sections = [
    { title: "Dlaczego Heliocantharus?", content: "<p>Jako gracze w gry fabularne lubimy czytać — wystarczy spojrzeć na objętość większości podręczników. Dlatego wierzę, że w fandomie RPG jest przestrzeń na dłuższe teksty.</p><p>Chciałbym za pomocą tego miejsca podzielić się z Tobą tym, co najbardziej cieszy mnie w grach fabularnych: nieograniczoną, symulacjonistyczną możliwością tworzenia światów i możliwością zaprojektowania zewnętrznych reguł tych światów według starannie dobranych zasad.</p><p><em>Heliocantharus</em> to pseudonim Michała Sędziwoja, polskiego XVII-wiecznego alchemika. Lubię alchemiczną estetykę i symbolikę i wykorzystuję je tutaj na różne sposoby.</p><hr>", id: "heliocantharus"},
    { title: "Kim jestem?", content: "<p>Nazywam się Mateusz Nowak. Jestem twórcą gier fabularnych i materiałów do RPG, autorem tekstów i podkastów, wydawcą, redaktorem i Mistrzem Gry od 2003 roku. Byłem związany z takimi projektami, jak <em>Twierdza Fantastyki</em>, <em>Blog i podkast k20</em> czy podkast <em>Siedzicie w karczmie</em>. Widziałem rzeczy, którym nie dalibyście wiary.</p><p>To wszystko nie ma jednak większego znaczenia. Lubię grać w erpegi i chciałbym pokazać Ci kilka fajnych rzeczy z nimi związanych.</p><hr>", id: "mateusz-nowak"},
    ...
    { title: "AI nie pisze moich tekstów", content: "<p>Wszystkie teksty na tym blogu i newsletter są w 100% napisane przeze mnie.</p><p>Nie mogę znieść generowanych treści w fandomie. Naprawdę nie interesuje mnie, co na temat RPG ma do powiedzenia AI — w razie czego sam ją zapytam. Wolę przeczytać autorski tekst lub komentarz, nawet jeśli będzie niedoskonały i niedopracowany.</p><p>Nie chcę być źle zrozumiany — nie jestem AI-luddystą. Sztuczna inteligencja, w tym LLM-y, to rewolucyjna technologia. Korzystam z niej w pracy, w której bardzo przyspiesza i ułatwia wykonywanie zadań. Google Gemini pomógł mi w zakodowaniu tego bloga.</p><p>Można powiedzieć, że <em>Heliocantharus RPG</em> to mój erpegowy AI-detoks.</p><hr>", id: "ai"}
  ] %}
